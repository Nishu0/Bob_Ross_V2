    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      ...
      <div className="flex flex-col">
        ...
        <div className={`${styles.flexCenter} flex-wrap gap-8`}>
          <h4 className="font-extrabold text-[24px] text-white">Bob Ross V2</h4>
          <p className="font-normal text-[14px] text-white opacity-50">Copyright © 2023 Nisarg Thakkar. All rights reserved.</p>
